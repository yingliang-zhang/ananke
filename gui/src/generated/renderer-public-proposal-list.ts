...
// To parse this data:
//
//   import { Convert, ProposalList } from "./file";
//
//   const proposalList = Convert.toProposalList(json);
//
...
export type State = "open" | "approved" | "withdrawn";

// Converts JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
export class Convert {
    public static toProposalList(json: string): ProposalList {
        return cast(JSON.parse(json), r("ProposalList"));
    }

    public static proposalListToJson(value: ProposalList): string {
        return JSON.stringify(uncast(value, r("ProposalList")), null, 2);
    }
}
