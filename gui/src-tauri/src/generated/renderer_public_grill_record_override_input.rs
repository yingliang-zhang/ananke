...
//
// use generated_module::RecordGrillOverrideInput;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: RecordGrillOverrideInput = serde_json::from_str(&json).unwrap();
// }
...
pub struct RecordGrillOverrideInput {
...
struct RecordGrillOverrideInputWire {
    proposal_id: String,
    question_id: String,
    revision: i64,
...
impl From<RecordGrillOverrideInputWire> for RecordGrillOverrideInput {
    fn from(wire: RecordGrillOverrideInputWire) -> Self {
        Self {
...
impl<'de> Deserialize<'de> for RecordGrillOverrideInput {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let value = Self::from(RecordGrillOverrideInputWire::deserialize(deserializer)?);
