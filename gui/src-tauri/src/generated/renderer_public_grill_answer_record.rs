...
//
// use generated_module::GrillAnswerRecord;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: GrillAnswerRecord = serde_json::from_str(&json).unwrap();
// }
...
impl From<GrillAnswerRecordWire> for GrillAnswerRecord {
    fn from(wire: GrillAnswerRecordWire) -> Self {
        Self {
            answer: wire.answer,
...
impl<'de> Deserialize<'de> for GrillAnswerRecord {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let value = Self::from(GrillAnswerRecordWire::deserialize(deserializer)?);
