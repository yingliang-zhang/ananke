...
//
// use generated_module::RecordGrillDefaultInput;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: RecordGrillDefaultInput = serde_json::from_str(&json).unwrap();
// }
...
pub struct RecordGrillDefaultInput {
...
struct RecordGrillDefaultInputWire {
    proposal_id: String,
    question_id: String,
    revision: i64,
...
impl From<RecordGrillDefaultInputWire> for RecordGrillDefaultInput {
    fn from(wire: RecordGrillDefaultInputWire) -> Self {
        Self {
...
impl<'de> Deserialize<'de> for RecordGrillDefaultInput {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let value = Self::from(RecordGrillDefaultInputWire::deserialize(deserializer)?);
