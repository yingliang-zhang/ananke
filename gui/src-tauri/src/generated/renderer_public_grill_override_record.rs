...
//
// use generated_module::GrillOverrideRecord;
//
// fn main() {
//     let json = r#"{"answer": 42}"#;
//     let model: GrillOverrideRecord = serde_json::from_str(&json).unwrap();
// }
...
pub struct GrillOverrideRecord {
    #[serde(rename = "override")]
    pub grill_override_record_override: Override,
...
struct GrillOverrideRecordWire {
    #[serde(rename = "override")]
    grill_override_record_override: Override,
    proposal_id: String,
    question_id: String,
    record_sequence: i32,
    revision: i64,
...
impl From<GrillOverrideRecordWire> for GrillOverrideRecord {
    fn from(wire: GrillOverrideRecordWire) -> Self {
        Self {
            grill_override_record_override: wire.grill_override_record_override,
...
impl<'de> Deserialize<'de> for GrillOverrideRecord {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let value = Self::from(GrillOverrideRecordWire::deserialize(deserializer)?);
